...
def create_account(username, password):
    ...
    browser = webdriver.Firefox(firefox_profile=profile, executable_path='your\path\geckodriver.exe')
    ...
    inp = input("[*] Solve captcha, create account, then press enter... enter 'r' as input if captcha doesn't appear to skip username" + '\n')
    if (inp == 'r'):
        os.system('clear')
        browser.quit()
        return False
